...
namespace inversify {
    ...
    export class Lookup<T extends interfaces.Clonable<T>> implements interfaces.Lookup<T> {
        ...
        public add(serviceIdentifier: interfaces.ServiceIdentifier<any>, value: T): void {
            ...
            if (serviceIdentifier === null || serviceIdentifier === undefined) { throw new Error(NULL_ARGUMENT); };
